...
## Knowledge Gaps
- **658 isolated node(s):** `here`, `AGENT_DIR`, `PKG`, `jiti`, `nodes` (+653 more)
...
- `Config Index (semantic audit map)` (3× useful, score=2.993432902)
- `~/.pi/agent config repo overview` (3× useful, score=2.993402812)
