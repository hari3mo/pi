...
## Corpus Check
- 210 files · ~156,204 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1123 nodes · 1554 edges · 62 communities (55 shown, 7 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.66)
- Token cost: 85,000 input · 9,000 output
...
- [[_COMMUNITY_Hermes Plugin Tests|Hermes Plugin Tests]]
...
- [[_COMMUNITY_Version Checker|Version Checker]]
...
- [[_COMMUNITY_Caveman Arm|Caveman Arm]]
...
1. `colors` - 52 edges
2. `colors` - 52 edges
3. `Config Index (semantic audit map)` - 19 edges
...
Cohesion: 0.06
Nodes (44): ponytail: ceiling-comment convention, Bug fix = root cause, not symptom (grep every caller), Ruleset mirror for agents, Compact always-on ruleset (AGENTS.md), Benchmark result: v4 hardening: test reflex + ceiling comments, no bloat creep, Benchmark result: Root-cause directive validated 6/6; reuse rung shipped, Ruleset mirror for clinerules, Ruleset mirror for github (+36 more)
...
Cohesion: 0.05
Nodes (41): additionalProperties, allOf, enum, type, enum, type, format, type (+33 more)
...
### Community 35 - "Hermes Plugin Tests"
Cohesion: 0.18
...
### Community 44 - "Version Checker"
Cohesion: 0.25
Nodes (6): distinct, fs, path, root, VERSION_FILES, versions

### Community 45 - "Command Tests"
Cohesion: 0.25
...
### Community 53 - "Caveman Arm"
Cohesion: 0.50
Nodes (3): fs, path, system

### Community 54 - "Ponytail Arm"
Cohesion: 0.50
Nodes (3): fs, path, system

## Knowledge Gaps
- **579 isolated node(s):** `autocommit.sh script`, `BANNER_LINES`, `APHORISMS`, `BANNER_WIDTH`, `SUBCOMMANDS` (+574 more)
...
- **Why does `Config Index (semantic audit map)` connect `TUI Extensions & Config Index` to `Heuristics Extension`, `Ponytail Ruleset & Mirrors`, `Subagent Dispatch Tool`, `Void Black-Hole TUI`, `Orchestration Doctrine & Roles`, `Task Tracker Extension`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `~/.pi/agent config repo overview` connect `Ponytail Ruleset & Mirrors` to `TUI Extensions & Config Index`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Ponytail project (lazy senior dev skill)` connect `Ponytail Ruleset & Mirrors` to `Brand & Chart Assets`?**
