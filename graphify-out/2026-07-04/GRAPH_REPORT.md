...
- [[_COMMUNITY_Statusline (Windows)|Statusline (Windows)]]
...
### Community 61 - "Statusline (Windows)"
Cohesion: 0.50
Nodes (3): fs, path, system
...
## Knowledge Gaps
- **579 isolated node(s):** `autocommit.sh script`, `BANNER_LINES`, `APHORISMS`, `BANNER_WIDTH`, `GraphParams` (+574 more)
