...
## Corpus Check
- 202 files · ~162,252 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1263 nodes · 1731 edges · 80 communities (71 shown, 9 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `53648a7e`
...
## Knowledge Gaps
- **648 isolated node(s):** `here`, `AGENT_DIR`, `PKG`, `jiti`, `cases` (+643 more)
...
- `Config Index (semantic audit map)` (3× useful, score=2.993449885)
- `~/.pi/agent config repo overview` (3× useful, score=2.993419795)
