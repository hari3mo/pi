...
| `peer` | deep reasoning (`openai/gpt-5.5:high`) | Gate-tier verification: existing behavior, 3+ files, auth/security, migrations, public API. Returns PASS / FAIL: implementation / FAIL: design. |
