...
- `Config Index (semantic audit map)` (3× useful, score=2.982126578)
- `~/.pi/agent config repo overview` (3× useful, score=2.982096602)
...
- **What connects `here`, `AGENT_DIR`, `PKG` to the rest of the system?**
