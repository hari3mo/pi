...
## Corpus Check
- 269 files · ~200,009 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1452 nodes · 1965 edges · 105 communities (96 shown, 9 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc6ec68f`
...
- [[_COMMUNITY_read-only-default.ts|read-only-default.ts]]
...
- [[_COMMUNITY_heuristic-entry.schema.json|heuristic-entry.schema.json]]
- [[_COMMUNITY_Pi Extension (Ponytail)|Pi Extension (Ponytail)]]
- [[_COMMUNITY_Package Scripts|Package Scripts]]
- [[_COMMUNITY_focus-chime.ts|focus-chime.ts]]
...
- [[_COMMUNITY_Single-shot benchmark (promptfoo, 5 tasks x 3 models)|Single-shot benchmark (promptfoo, 5 tasks x 3 models)]]
...
- [[_COMMUNITY_check-concurrency-guard.mjs|check-concurrency-guard.mjs]]
- [[_COMMUNITY_config-paths.ts|config-paths.ts]]
- [[_COMMUNITY_ponytail-statusline.sh script|ponytail-statusline.sh script]]
- [[_COMMUNITY_graph-lookup.ts|graph-lookup.ts]]
- [[_COMMUNITY_ponytail.js|ponytail.js]]
- [[_COMMUNITY_porcelain.json|porcelain.json]]
- [[_COMMUNITY_Compact always-on ruleset (AGENTS.md)|Compact always-on ruleset (AGENTS.md)]]
- [[_COMMUNITY_Orchestration Doctrine (AGENTS.md)|Orchestration Doctrine (AGENTS.md)]]
- [[_COMMUNITY_porcelain.json|porcelain.json]]
- [[_COMMUNITY_porcelain.json|porcelain.json]]
- [[_COMMUNITY_lead-config.ts|lead-config.ts]]
- [[_COMMUNITY_ponytail.js|ponytail.js]]
- [[_COMMUNITY_porcelain-light.json|porcelain-light.json]]
- [[_COMMUNITY_heuristic-entry.schema.json|heuristic-entry.schema.json]]
...
- [[_COMMUNITY_porcelain.json|porcelain.json]]
- [[_COMMUNITY_Compact always-on ruleset (AGENTS.md)|Compact always-on ruleset (AGENTS.md)]]
- [[_COMMUNITY_ponytail skill (lazy senior dev mode)|ponytail skill (lazy senior dev mode)]]
- [[_COMMUNITY_Ponytail project (lazy senior dev skill)|Ponytail project (lazy senior dev skill)]]
- [[_COMMUNITY_Single-shot benchmark (promptfoo, 5 tasks x 3 models)|Single-shot benchmark (promptfoo, 5 tasks x 3 models)]]
- [[_COMMUNITY_Compact always-on ruleset (AGENTS.md)|Compact always-on ruleset (AGENTS.md)]]
- [[_COMMUNITY_ponytail skill (lazy senior dev mode)|ponytail skill (lazy senior dev mode)]]
...
Cohesion: 0.06
Nodes (52): ACTIVE_SUBAGENT_LISTENERS, ACTIVE_SUBAGENT_RUNS, ActiveSubagentMeta, ActiveSubagentPanel, AgentScopeSchema, ChainItem, contentToText(), DisplayItem (+44 more)
...
Cohesion: 0.08
Nodes (25): Graph Maintenance Runbook, execute(), findGraphRoot(), fmtAge(), GraphParams, GraphStats, runGraphify(), statusText() (+17 more)
...
Cohesion: 0.32
Nodes (14): The Ladder (YAGNI→reuse→stdlib→native→dep→one line→minimum), Platform-native solution tables (HTML/CSS/JS/Swift/Node/Python/DB), Example: csv-sum before/after, Example: debounce before/after, Example: deep-clone before/after, Example: email-validation before/after, Example: group-by before/after, Example: infinite-scroll before/after (+6 more)
...
Cohesion: 0.25
Nodes (9): APHORISMS, BANNER_LINES, BANNER_WIDTH, computeContextLine(), getAphorism(), getBanner(), getGreeting(), render() (+1 more)
...
Cohesion: 0.14
Nodes (14): minimum, type, minLength, type, format, type, type, type (+6 more)
...
Cohesion: 0.17
Nodes (11): additionalProperties, items, minItems, type, description, $id, minLength, type (+3 more)
...
### Community 35 - "read-only-default.ts"
Cohesion: 0.25
...
Cohesion: 0.23
Nodes (17): check_autocommit_liveness(), check_connectivity_ratchet(), check_extension_loads(), check_flag_staleness(), check_graph_first_drift(), check_graph_freshness(), check_lead_profile_coverage(), check_oracle_staleness() (+9 more)

### Community 45 - "execute"
Cohesion: 0.22
...
### Community 48 - "heuristic-entry.schema.json"
Cohesion: 0.36
Nodes (7): AgentConfig, AgentDiscoveryResult, AgentScope, discoverAgents(), findNearestProjectAgentsDir(), isDirectory(), loadAgentsFromDir()

### Community 49 - "Pi Extension (Ponytail)"
Cohesion: 0.38
Nodes (3): fmtDuration(), fmtTokens(), SPINNER_FRAMES

### Community 51 - "focus-chime.ts"
Cohesion: 0.83
...
Cohesion: 0.50
Nodes (3): cases, jiti, PKG

### Community 61 - "check-versions.js"
Cohesion: 0.25
Nodes (6): distinct, fs, path, root, VERSION_FILES, versions

### Community 63 - "commands.test.js"
Cohesion: 0.25
Nodes (7): assert, commands, fs, path, piSource, root, test

### Community 65 - "copilot-plugin.test.js"
Cohesion: 0.25
Nodes (6): assert, fs, path, REQUIRED_COMMAND_FILES, root, test

### Community 67 - "porcelain-light.json"
Cohesion: 0.25
Nodes (6): AGENT_DIR, cases, here, jiti, PKG, state

### Community 68 - "check-parse-verdict.mjs"
Cohesion: 0.29
Nodes (6): cases, here, parseQaVerdict, src, start, stripped

### Community 69 - "check-concurrency-guard.mjs"
Cohesion: 0.10
Nodes (15): AGENT_DIR, ctx, emitted, foreignCommit(), g(), handlers, here, jiti (+7 more)

### Community 74 - "graph-lookup.ts"
Cohesion: 0.18
Nodes (5): GraphLink, GraphNode, InboundRef, LoadedGraph, RawGraph

### Community 75 - "ponytail.js"
Cohesion: 0.25
Nodes (4): GraphFirstAction, GraphFirstState, GrepClassification, StatsRecord

### Community 76 - "porcelain.json"
Cohesion: 0.08
Nodes (25): minimum, type, minimum, type, description, $id, minLength, type (+17 more)

### Community 78 - "Compact always-on ruleset (AGENTS.md)"
Cohesion: 0.13
Nodes (11): AGENT_DIR, expectKeys, flaggedAt, here, jiti, links, nodes, PKG (+3 more)

### Community 79 - "Orchestration Doctrine (AGENTS.md)"
Cohesion: 0.12
...
### Community 80 - "porcelain.json"
Cohesion: 0.07
Nodes (32): description, description, items, type, description, minimum, type, $id (+24 more)

### Community 81 - "porcelain.json"
Cohesion: 0.07
Nodes (27): description, description, type, description, type, $id, items, additionalProperties (+19 more)

### Community 82 - "lead-config.ts"
Cohesion: 0.21
Nodes (7): isUsableId(), LeadProfile, loadProfiles(), matchProfile(), parseProfiles(), patternMatches(), StatsRecord

### Community 83 - "ponytail.js"
Cohesion: 0.18
Nodes (8): AGENT_DIR, cases, fableBlock, here, jiti, opusBlock, PKG, profiles

### Community 84 - "porcelain-light.json"
Cohesion: 0.20
Nodes (9): additionalProperties, type, description, $id, propertyNames, pattern, $schema, title (+1 more)

### Community 85 - "heuristic-entry.schema.json"
Cohesion: 0.22
Nodes (8): additionalProperties, allOf, description, $id, required, $schema, title, type

### Community 86 - "manifest.json"
Cohesion: 0.25
Nodes (7): $comment, layout, $comment, expected, known, schemaVersion, targets

### Community 87 - "porcelain.json"
Cohesion: 0.40
Nodes (4): defaultViewMode, livePreview, showFrontmatter, strictLineBreaks
...
### Community 89 - "basis"
Cohesion: 0.67
Nodes (3): enum, type, basis

### Community 90 - "category"
Cohesion: 0.67
Nodes (3): enum, type, category

### Community 91 - "created"
Cohesion: 0.67
Nodes (3): format, type, created

### Community 92 - "scope"
Cohesion: 0.67
Nodes (3): scope, enum, type

### Community 93 - "source"
Cohesion: 0.67
Nodes (3): source, enum, type

### Community 94 - "porcelain-light.json"
Cohesion: 0.20
Nodes (11): addCandidate(), buildStagedNote(), candidateKey(), Captured, CAPTURED_ACTIONS, deriveSummary(), isSubstantive(), normalizeQuestion() (+3 more)

### Community 95 - "ponytail.js"
Cohesion: 0.25
Nodes (6): AGENT_DIR, cases, here, jiti, PKG, state

### Community 96 - "porcelain.json"
Cohesion: 0.24
Nodes (7): classifyPiDocRead(), DOC_SUBPATHS, DocReadClassification, extractPiPkgPath(), isPiDocPath(), OracleFirstAction, OracleFirstState

### Community 97 - "Compact always-on ruleset (AGENTS.md)"
Cohesion: 0.29
Nodes (6): export, cardBg, infoBg, pageBg, name, $schema

### Community 98 - "ponytail skill (lazy senior dev mode)"
Cohesion: 0.13
Nodes (11): AGENT_DIR, args, buffer, { filename, content }, here, jiti, LONG, nm (+3 more)

### Community 99 - "Ponytail project (lazy senior dev skill)"
Cohesion: 0.15
Nodes (14): GitHub sponsors funding config, OpenClaw copy of ponytail-audit skill (generated), OpenClaw copy of ponytail-gain skill (generated), OpenClaw copy of ponytail-help skill (generated), OpenClaw copy of ponytail-review skill (generated), OpenCode /ponytail-audit command, OpenCode /ponytail-gain command, OpenCode /ponytail-help command (+6 more)

### Community 100 - "Single-shot benchmark (promptfoo, 5 tasks x 3 models)"
Cohesion: 0.17
Nodes (13): Chart: median LOC per arm (518/116/39 Haiku etc.), Vendored caveman skill (terse-prose control arm), benchmark config: Behavior gates (hardware/explanation/one-check probes), benchmark config: Claude 3-arm config, benchmark config: Gemini config, benchmark config: GPT-mini issue-65 repro config, benchmark config: Newest-OpenAI config, Honesty note: single-shot 80-94% inflated by chatty baseline (+5 more)

### Community 101 - "Compact always-on ruleset (AGENTS.md)"
Cohesion: 0.20
...
### Community 102 - "ponytail skill (lazy senior dev mode)"
Cohesion: 0.25
Nodes (8): Hermes after-install notes, Never-lazy floor (validation, data loss, security, a11y), Benchmark result: parseaddr email slip is provider-specific (OpenAI), Claude 100%, OpenClaw copy of ponytail skill (generated), OpenCode /ponytail command, Hermes plugin manifest, Intensity levels (lite/full/ultra), ponytail skill (lazy senior dev mode)

### Community 103 - "ponytail-debt skill — ponytail: comment debt ledger"
Cohesion: 0.40
...
### Community 104 - "ponytail.js"
Cohesion: 0.50
Nodes (3): fs, path, system

## Knowledge Gaps
- **739 isolated node(s):** `here`, `AGENT_DIR`, `PKG`, `nm`, `jiti` (+734 more)
...
- `Config Index (semantic audit map)` (3× useful, score=2.978212928)
- `~/.pi/agent config repo overview` (3× useful, score=2.978182991)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Config Index (semantic audit map)` connect `Example Generator & LOC Metric` to `Heuristics Extension`, `Compact always-on ruleset (AGENTS.md)`, `Ponytail MCP Server`, `read-only-default.ts`, `TUI Extensions & Config Index`, `Subagent Dispatch Tool`, `Ponytail Hook Tests`, `Orchestration Doctrine (AGENTS.md)`, `Void Black-Hole TUI`, `Pi Extension (Ponytail)`, `Package Scripts`, `focus-chime.ts`, `Correctness Gate`, `manifest.json`, `Task Tracker Extension`?**
  _High betweenness centrality (0.335) - this node is a cross-community bridge._
- **Why does `~/.pi/agent config repo overview` connect `Subagent Dispatch Tool` to `Ponytail project (lazy senior dev skill)`, `Example Generator & LOC Metric`?**
  _High betweenness centrality (0.256) - this node is a cross-community bridge._
- **Why does `Malleable schema policy` connect `Subagent Dispatch Tool` to `Ponytail Ruleset & Mirrors`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **What connects `Live installed pi version from its package manifest (the same source the     too`, `here`, `AGENT_DIR` to the rest of the system?**
